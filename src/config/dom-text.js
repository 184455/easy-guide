 ...
 */
import {
  MODE, dataSet, TemplateItemTop, PreviewBtn, OperationBarDrag,
  PrevBtnName, NextBtnName, DeleteBtn, EditBtn, ViewCloseBtn, GuideDragItem, ExitPreview
} from './constant'
...
export function getGuideItemDomText (guideItem, mode) {
  ...
  return `
    <div id="${id}" class="e_guide-item" ${dataSet(GuideDragItem)} style="${styles}">
      ${dots}
