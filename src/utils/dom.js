...
import {
  ...
  EditBtn, GuideDragItem, RootId, DragTemplate, MODE, PreviewBtn, ExitPreview
...
export function exitPreview (flag) {
  return flag ? `<div ${DataSetName}="${ExitPreview}" class="_eg-exit-preview">退出预览</div>` : ''
}
